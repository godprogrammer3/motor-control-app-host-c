    ...
    <v-row align="center" justify="center">
      ...
      <v-col>
        <TouchKeyboardWithFinish
          @keyboard-event="keyboardEventHandler"
        ></TouchKeyboardWithFinish>
      </v-col>
    </v-row>
      ...
      if (event.type == "letter" && event.value != ".") {
        if (this.currentInput == "wast") {
          ...
          if (
            ...
            this.wast =
              this.wast.substring(0, element.selectionStart) +
              event.value +
              this.wast.substring(element.selectionEnd);
            this.$nextTick(() => {
              element.focus();
        ...
        if (event.value == "delete") {
          if (this.currentInput == "wast") {
            ...
            if (element.selectionStart == element.selectionEnd) {
              ...
              this.wast =
                this.wast.substring(0, element.selectionStart - 1) +
                this.wast.substring(element.selectionEnd);
            } else {
          ...
          this.$emit("popup-add-wast-paper-event", {
            type: "action",
            value: "finish",
          });
        }
